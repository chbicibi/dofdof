module util
    ...
    ! 定数
    ! ==========================================================================
    real(8), parameter :: NaN = transfer(z'7ff8000000000000', 0d0)
    ...
    function join_s(array, sep) result(res)
        ...
        if (present(sep)) then
            do i = 2, size(array)
                res = res // sep // array(i)%data
            end do
        else
            do i = 2, size(array)
                res = res // array(i)%data
            end do
        end if
    end function join_s
    ...
    type(str) function concat_c(this, s) result(res)
    ...
    type(str) function concat_s(this, s) result(res)
        class(str), intent(inout) :: this
        class(str), intent(in) :: s

        res = str(this%data // s%data)
    end function concat_s


    type(str) function serstr_n(prefix, n, suffix, digits) result(res)
        ...
        if (present(suffix)) then
            res = str(prefix // str(n, dig) // suffix)
        else
            res = str(prefix // str(n, dig))
        end if
